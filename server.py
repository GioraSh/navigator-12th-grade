...
def admin_handler(clientsock,addr):
    ...
    while data!="close":
        if data=="history":
            ...
            print data
            print eval(data[0])
            data[0]=convert_streets_to_coordinates(*eval(data[0]))
            data[1]=convert_streets_to_coordinates(*eval(data[1]))
            data[0]=convert_coordinate_to_id(*data[0])
            data[1]=convert_coordinate_to_id(*data[1])
            data=get_road_id(data[0],data[1])
            print data
